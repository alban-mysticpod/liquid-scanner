  ...
  const getIcon = (settingType: string) => {
    switch (settingType) {
      ...
      case 'select':
        return (
          <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            <rect x="3" y="6" width="18" height="4" rx="2" ry="2"/>
            <rect x="3" y="10" width="18" height="4" rx="2" ry="2"/>
            <rect x="3" y="14" width="18" height="4" rx="2" ry="2"/>
            <polyline points="16,8 18,8 18,16 16,16"/>
          </svg>
        );
